"""
Django settings for responders project.
...
SECRET_KEY = 'u28*k34pf@l(!nb9iwvyis=nq0^up!9z&%0avfa!a_k+y$h5+f'
...
WSGI_APPLICATION = 'responders.wsgi.application'
